...
public class ServidorDeObjetos {
  ...
  public static void main(String args[]) {
    try{
      ...
      GesPacientesImpl convref = new GesPacientesImpl();
      //convref.setORB(orb); 
      //*** crea un tie, con el servant como delegado***
      GestionPacientesPOATie gptie= new GestionPacientesPOATie(convref);
	  ...
	  convref.consultarReferenciaRemota(ncref,"objNotificaciones");
