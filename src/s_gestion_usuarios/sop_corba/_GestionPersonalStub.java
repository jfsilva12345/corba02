...
/**
* s_gestion_usuarios/sop_corba/_GestionPersonalStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from s_gestion_usuarios.idl
* martes 15 de febrero de 2022 10:52:48 AM COT
*/

public class _GestionPersonalStub extends org.omg.CORBA.portable.ObjectImpl implements s_gestion_usuarios.sop_corba.GestionPersonal
{
  ...
  public void registrarPersonal (s_gestion_usuarios.sop_corba.GestionPersonalPackage.personalDTO objPersonal, org.omg.CORBA.BooleanHolder res)
  {
            ...
            try {
                ...
                s_gestion_usuarios.sop_corba.GestionPersonalPackage.personalDTOHelper.write ($out, objPersonal);
                $in = _invoke ($out);
  ...
  public boolean consultarPersonal (int id, s_gestion_usuarios.sop_corba.GestionPersonalPackage.personalDTOHolder objPersonal)
  {
            ...
            try {
                ...
                objPersonal.value = s_gestion_usuarios.sop_corba.GestionPersonalPackage.personalDTOHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public int abrirSesion (s_gestion_usuarios.sop_corba.GestionPersonalPackage.CredencialDTO objCredencial)
  {
            ...
            try {
                ...
                s_gestion_usuarios.sop_corba.GestionPersonalPackage.CredencialDTOHelper.write ($out, objCredencial);
                $in = _invoke ($out);
